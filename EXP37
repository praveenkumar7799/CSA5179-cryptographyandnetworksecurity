...
int main() {
    ...
    // Create a copy of the key for potential modification
    char tempKey[26];

    double minDiff = 1e9; // Initialize a large value for minimum difference

    // Loop through all possible permutations of the key
    do {
    ...
    decryptMonoalphabetic(ciphertext, tempKey, plaintext);
